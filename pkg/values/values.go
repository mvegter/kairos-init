...
// RHELFamilyRegex matches RHEL-family distributions such as Fedora, CentOS, Rocky, AlmaLinux, Red Hat, and Oracle Linux.
const (
	...
	AlpineRegex                  = "Alpine.*"
	RHELFamilyRegex              = "Fedora.*|CentOS.*|Rocky.*|AlmaLinux.*|Red\\sHat.*|Oracle\\sLinux.*"
)
